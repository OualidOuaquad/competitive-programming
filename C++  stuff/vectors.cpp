...
{ 
    ...
    cout << "\nThe first element after insert command is:\n " << vec[0]; 
   
    // removes the first element 
    vec.erase(vec.begin()); 
   
    cout << "\nThe first element after erase command is:\n " << vec[0]; 
   
    // inserts at the beginning 
    vec.emplace(vec.begin(), 5); 
    cout << "\nThe first element emplace is:\n " << vec[0]; 
   
    // Inserts 20 at the end 
    vec.emplace_back(20); 
    s = vec.size(); 
    cout << "\nThe last element after emplace_back is: \n" << vec[s - 1]; 
    ...
    vector <int> bla = {1, 2, 3, 4} ; 
    bla.insert(bla.begin() + 2, 100000);
    for(auto i : bla ){
        cout << i << ' ';
    }
}  
